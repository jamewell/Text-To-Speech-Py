...
<div>
	...
	<div class="relative">
		<input
			...
			{placeholder}
			{autocomplete}
			class="w-full rounded-lg border border-gray-300 px-4 py-2 pr-10 transition-colors focus:border-transparent focus:ring-2 focus:ring-blue-500 disabled:cursor-not-allowed disabled:bg-gray-100"
			required
		/>
		<button
			type="button"
